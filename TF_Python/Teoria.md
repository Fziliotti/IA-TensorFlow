...
A rede neural vai ser treinada para reconhecer dígitos escritos à mão. A base de dados usada para o treinamento e teste da IA [será essa daqui](https://www.tensorflow.org/api_docs/python/tf/keras/datasets/mnist)

## Exemplo da matriz x_train[12]
